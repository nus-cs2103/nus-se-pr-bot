...
module.exports = function(accuser, repoName) {
  ...
  repo.newWorker()
    ...
    .do(function(repository, issue) {
      ...
      accuser.comment(repository, issue, "This PR should be against a repo in the org [nus-cs2103-AY1617S1](https://github.com/nus-cs2103-AY1617S1), not against the repo in se-edu org :-)\n\nClosing ...");
